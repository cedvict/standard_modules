...
exports.PosModel = Backbone.Model.extend({
    ...
    models: [
    {
        ...
        model:  'res.company',
        fields: [ 'currency_id', 'email', 'website', 'company_registry', 'vat', 'name', 'phone', 'partner_id' , 'country_id', 'tax_calculation_rounding_method','nit_empresa'],
        ...
        model:  'res.partner',
        fields: ['name','street','city','state_id','country_id','vat','phone','zip','mobile','email','barcode','write_date','property_account_position_id','nit'],
        ...
        fields: ['type', 'sequence', 'fecha_limite'],
...
exports.Order = Backbone.Model.extend({
    ...
    generate_unique_id: function() {
        ...
        return zero_pad(this.pos.pos_session.login_number,3) +'-'+
	       zero_pad(this.pos.pos_session.id,1) +
               zero_pad(this.pos.pos_session.login_number,1) +
               orderNo++;
    },
    get_name: function() {
        return this.name;
